...
void CnpPatcher::patch(
    ...
    const auto stencil_size = stencil.size();
        ...
        case INDIRECT_21:
            {
                ...
                const auto ip_page = reinterpret_cast<uint64_t>(function_pointer + function_offset + patch.address) & ~0xFFF;
